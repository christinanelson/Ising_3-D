...
void shplot()
{
  ...
  //g1->GetYaxis()->SetTitle("Heat Capacity, (JK/g) ");
  g1->GetYaxis()->SetTitle("Susceptibility, (T^{-1}m^{-3}) ");
  ...
  c1->SaveAs("susceptibility.eps");
  c1->SaveAs("susceptibility.png");
}
