...
void mplot()
{
  ...
  TGraph * g1 = new TGraph("magnetization.dat");
  ...
  g1->GetYaxis()->SetTitle("Magnetization, (JT^{-1}m^{-3})");
  ...
  g1->GetYaxis()->SetTitleOffset(0.92);
  ...
  c1->SetGrid();
  c1->Update();
  c1->SaveAs("magnetization.eps");
  c1->SaveAs("magnetization.png");;
}
